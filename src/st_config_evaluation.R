...
st_config <- read_csv(file.path(version_dir, 'confusion_matrix', 'confusion_matrices.csv')) %>%
  ...
  mutate(
    ...
    misclassification_rate = (modisT_mtbsF_modis_over_th + modisF_mtbsT)/ (modisT_mtbsF_modis_over_th + modisT_mtbsT + modisF_mtbsT),
    true_positive_rate = modisT_mtbsT / (modisF_mtbsT	+ modisT_mtbsT),
    precision = modisT_mtbsT / total_modis,
    prevelance = (modisF_mtbsT + modisT_mtbsT) / (modisT_mtbsF_modis_over_th + modisT_mtbsT + modisF_mtbsT),
