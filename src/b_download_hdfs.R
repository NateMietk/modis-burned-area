...
system("aws s3 sync s3://earthlab-natem/data/disturbances/fire/mcd64a1/hdf_months data/MCD64A1/C6/hdf_months")
...
system("aws s3 sync  data/MCD64A1/C6/hdf_months s3://earthlab-natem/data/disturbances/fire/mcd64a1/hdf_months")
