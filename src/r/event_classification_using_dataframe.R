...
system("aws s3 sync s3://earthlab-natem/modis-burned-area/MCD64A1/C6/tif_converted/ /home/a/projects/modis-burned-area/data/scrap/")

tifs <- list.files("data/scrap", full.names = T) 
